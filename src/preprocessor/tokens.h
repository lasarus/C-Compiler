...
X(T_STRING, "String")
X(T_STRING_CHAR32, "char32_t String")
X(T_STRING_CHAR16, "char16_t String")
X(T_STRING_WCHAR, "wchar_t String")
X(T_CHARACTER_CONSTANT, "Character constant")
X(T_CHARACTER_CONSTANT_CHAR32, "char32_t character constant")
X(T_CHARACTER_CONSTANT_CHAR16, "char16_t character constant")
X(T_CHARACTER_CONSTANT_WCHAR, "wchar_t character constant")
X(T_NUM, "Numerical")
