...
const char *binary_operator_outputs[OT_TYPE_COUNT][OP_TYPE_COUNT] = {
	...
	[OT_ULONG][OP_ADD] = "leal\t(%rdi,%rsi), %eax\n",
	[OT_ULONG][OP_SUB] = "movl\t%edi, %eax\n\tsubl\t%esi, %eax\n",
	[OT_ULONG][OP_MUL] = "movl\t%edi, %eax\n\timull\t%esi, %eax\n",
	[OT_ULONG][OP_DIV] = "movl\t%edi, %eax\n\txorl\t%edx, %edx\n\tdivl\t%esi\n",
	[OT_ULONG][OP_MOD] = "movl\t%edi, %eax\n\txorl\t%edx, %edx\n\tdivl\t%esi\n\tmovl\t%edx, %eax\n",
	[OT_ULONG][OP_BXOR] = "movl\t%edi, %eax\n\txorl\t%esi, %eax\n",
	[OT_ULONG][OP_BOR] = "movl\t%edi, %eax\n\torl\t%esi, %eax\n",
	[OT_ULONG][OP_BAND] = "movl\t%edi, %eax\n\tandl\t%esi, %eax\n",
	[OT_ULONG][OP_LSHIFT] = "movl\t%edi, %eax\n\tmovl\t%esi, %ecx\n\tsall\t%cl, %eax\n",
	[OT_ULONG][OP_RSHIFT] = "movl\t%edi, %eax\n\tmovl\t%esi, %ecx\n\tshrl\t%cl, %eax\n",
